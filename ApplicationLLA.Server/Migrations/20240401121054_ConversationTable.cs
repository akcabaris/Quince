    ...
    public partial class ConversationTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Workers", x => x.AppUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    WorkerAppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_Customer_CustomerAppUserId",
                        column: x => x.CustomerAppUserId,
                        principalTable: "Customer",
                        principalColumn: "AppUserId");
                    table.ForeignKey(
                        name: "FK_Messages_Workers_WorkerAppUserId",
                        column: x => x.WorkerAppUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "AppUserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_CustomerAppUserId",
                table: "Messages",
                column: "CustomerAppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_WorkerAppUserId",
                table: "Messages",
                column: "WorkerAppUserId");
