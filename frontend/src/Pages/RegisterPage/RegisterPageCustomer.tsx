...
const validation = Yup.object().shape({
  accountType: Yup.string().required("Account Type is required").default("Customer"),
  email: Yup.string()
  ...
  userName: Yup.string().required("Username is required").lowercase().matches(/^[^\s]+$/, "You can't use space character for this").min(6,"Min 6 Character"),
  password: Yup.string().required("Password is required").min(12, 'Password to short').max(20, "Max 20 Character")
...
const RegisterPageCustomer = (props: Props) => {
  ...
  return (
    <section className='bg-gray-50 '>
      ...
      <div className='w-full bg-gray-50 rounded-xl shadow-lg border-gray-600 md:mb-20 sm:max-w-md xl:p-0 xl:absolute xl:top-5'>
